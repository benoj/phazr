...
from .models import Operation, ExecutionResult, EnvironmentConfig, OperationType
...
class KubectlRestartHandler(OperationHandler):
    ...
    async def _wait_for_ready(
        ...
        if process.returncode != 0:
            raise Exception(f"Deployment {deployment} did not become ready within {timeout} seconds")
