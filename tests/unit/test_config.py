...
class TestConfigManager:
    ...
    def sample_config_dict(self):
        ...
        return {
            ...
            "metadata": {"created_by": "phazr", "version": "1.0.0"},
        }
    ...
    def test_save_yaml_config(
        self, config_manager, sample_orchestrator_config, tmp_path
    ):
    ...
    def test_deep_merge(self, config_manager):
        ...
        base = {"a": {"b": 1, "c": 2}, "d": [1, 2, 3], "e": "original"}
    ...
    def test_validate_config_no_versions(self, config_manager):
        ...
        config = OrchestratorConfig(
            versions={}, environment=EnvironmentConfig(name="test", namespace="default")
        )
