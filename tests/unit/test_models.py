...
class TestPhaseResult:
    ...
    def sample_operations(self):
        ...
        return [
            Operation(command="echo 1", description="Op 1", type=OperationType.SCRIPT_EXEC),
            Operation(command="echo 2", description="Op 2", type=OperationType.SCRIPT_EXEC),
            Operation(command="echo 3", description="Op 3", type=OperationType.SCRIPT_EXEC),
        ]
...
class TestVersionConfig:
    ...
    def test_version_config_creation(self):
        ...
        operations = {
            "build": [
                Operation(command="make build", description="Build", type=OperationType.SCRIPT_EXEC)
            ],
            "test": [
                Operation(command="make test", description="Test", type=OperationType.SCRIPT_EXEC)
            ]
        }
        ...
        with pytest.raises(ValidationError) as exc_info:
            VersionConfig(
                ...
                groups={
                    ...
                    "test": [
                        Operation(command="test", description="Test", type=OperationType.SCRIPT_EXEC)
                    ]
                }
            )
...
class TestOrchestratorConfig:
    ...
    def sample_version_config(self):
        ...
        operations = {
            "build": [
                Operation(command="make", description="Build", type=OperationType.SCRIPT_EXEC)
            ]
        }
    ...
    def test_orchestrator_config_defaults(self, sample_version_config, sample_environment):
