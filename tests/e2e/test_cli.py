...
class TestCLICommands:
    ...
    def test_cli_dry_run_flag(self, runner, sample_config_file):
        ...
        with patch("phazr.cli.asyncio.run") as mock_run:
            ...
            result = runner.invoke(cli, ["-c", str(sample_config_file), "--dry-run", "validate"])
    ...
    def test_cli_verbose_flag(self, runner, sample_config_file):
        ...
        with patch("phazr.cli.asyncio.run") as mock_run:
            ...
            result = runner.invoke(cli, ["-c", str(sample_config_file), "--verbose", "validate"])
...
class TestSetupCommand:
    ...
    def test_setup_with_version(self, runner, sample_config_file):
        ...
        with patch("phazr.cli.asyncio.run") as mock_run:
            ...
            result = runner.invoke(cli, ["-c", str(sample_config_file), "setup", "--version", "1.0.0"])
...
class TestRunCommand:
    ...
    def test_run_invalid_phase(self, runner, sample_config_file):
        ...
        result = runner.invoke(cli, ["-c", str(sample_config_file), "run", "nonexistent"])
    ...
    def test_run_with_version(self, runner, sample_config_file):
        ...
        with patch("phazr.cli.asyncio.run") as mock_run:
            ...
            result = runner.invoke(cli, ["-c", str(sample_config_file), "run", "build", "--version", "1.0.0"])
...
class TestMergeCommand:
    ...
    def test_merge_configs_to_file(self, runner, tmp_path):
        ...
        config2 = {"environment": {"namespace": "default"}, "execution": {"verbose": True}}
    ...
    def test_list_phases_empty(self, runner, tmp_path):
        ...
        config_data = {
            ...
            "versions": {
                "1.0.0": {
                    "build": [
                        {"command": "echo build", "description": "Build", "type": "script_exec"}
                    ]
                }
            },
    ...
    def test_cli_with_different_config_formats(self, runner, tmp_path):
        ...
        config_data = {
            ...
            "versions": {
                "1.0.0": {
                    "test_group": [
                        {"command": "echo test", "description": "Test", "type": "script_exec"}
                    ]
                }
            },
            "environment": {"name": "test", "namespace": "default"}
